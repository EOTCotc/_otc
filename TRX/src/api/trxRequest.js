...
//商家USDT余额不足校验
export const VerifyOrder = ({ ads = localStorage.getItem('myaddress'), sign = localStorage.getItem('mysign'), id, num, type }) => {
...
//防止误触
export const VerifyReleaseCoins = ({ ads = localStorage.getItem('myaddress'), sign = localStorage.getItem('mysign'), oid }) => {
...
export const StakingEotc = ({ ads = localStorage.getItem('myaddress'), sign = localStorage.getItem('mysign'), net = localStorage.getItem('netType'), num, zq, hx = 'node' }) => {
...
//充值
export const Recharge = ({ ads = localStorage.getItem('myaddress'), uid = localStorage.getItem('uid'), net, hx, usdt }) => {
...
//充值记录
export const RechargeList = ({ ads = localStorage.getItem('myaddress'), uid = localStorage.getItem('uid') }) => {
...
//获取质押记录
export const MyStakeList = ({ ads = localStorage.getItem('myaddress'), net = localStorage.getItem('netType'), zq = 0 }) => {
	const params = {
		ads,
		net,
		zq
...
//申诉提交
export const Petition = ({ uuid = localStorage.getItem('uid'), oid, type, msg }) => {
	const params = {
		uuid,
		oid,
		msg,
...
//二期提现
export const WithdrawCoins = ({ ads = localStorage.getItem('myaddress'), sign = localStorage.getItem('mysign'), num, coin, hx }) => {
	const params = {
		ads,
		sign,
		num,
...
export const Gettbjl = ({ uid = localStorage.getItem('uid') }) => {
	const params = {
		uid
	};
	return request({
...
// https://api.eotcyu.club/api/EOTC/UnStakeOtc?id=订单编号

// 赎回
export const UnStakeOtc = (id, type) => {
	const params = {
		id,
		type
	};
